...
if __name__ == "__main__":
    ...
    print("input_sekuens (indeks kata): ", input_sekuens)
    ...
    print("output dari embedding (representasi numerik): ", embed_output.shape)

    output_dengan_positional_encoding = positional_encoding_layer(embed_output)
    print("output dengan positional encoding: ", output_dengan_positional_encoding.shape)

    print("nilai output dengan positional encoding: ", output_dengan_positional_encoding[0, :2, :5])